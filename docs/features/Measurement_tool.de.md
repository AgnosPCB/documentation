...
[Wählen Sie ein Referenzbild aus](../how_to/Screen-layout.md#referenz-als-datei-laden), auf dem Sie eine Messung durchführen möchten, oder [erfassen Sie eine UUI](../how_to/Inspection_workflow.md#aufnehmen-einer-uui).

## 2. Messwerkzeug öffnen

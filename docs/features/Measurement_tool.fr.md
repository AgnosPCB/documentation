...
[Sélectionnez une image de référence](../how_to/Screen-layout.md#charger-reference-en-tant-que-fichier) sur laquelle vous souhaitez effectuer une mesure, ou bien [capturez une UUI](../how_to/Inspection_workflow.md#capture-dune-uui).

## 2. Ouvrir l’outil de mesure

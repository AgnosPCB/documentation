...
[Cree una imagen de referencia](../how_to/Inspection_workflow.md#generacion-de-una-referencia) o seleccione una [del repositorio](../how_to/Screen-layout.md#cargar-referencia-como-archivo). Luego, coloque la UUI e inicie la inspección.
...
![Informe PDF de variante de referencia](../assets/ref-variant-report.png){width=600 .center}

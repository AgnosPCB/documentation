...
[Créer une image de référence](../how_to/Inspection_workflow.md#generation-dune-reference) ou en sélectionner une [depuis le dépôt](../how_to/Screen-layout.md#charger-reference-en-tant-que-fichier). Ensuite, placez l’UUI et lancez l’inspection.

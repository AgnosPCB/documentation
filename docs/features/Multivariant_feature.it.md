...
[Crea un'immagine di riferimento](../how_to/Inspection_workflow.md#generazione-di-un-riferimento) oppure selezionane una [dal repository](../how_to/Screen-layout.md#carica-riferimento-come-file). Quindi, posiziona l'UUI e avvia l'ispezione.

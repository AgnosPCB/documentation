...
Per generare un'immagine di **RIFERIMENTO**, segui i passaggi nella [seguente guida](../how_to/Inspection_workflow.md#generazione-di-un-riferimento) oppure [carica un RIFERIMENTO precedente](../how_to/Screen-layout.md#carica-riferimento-come-file).

## 2. Aprire la Live View

Utilizza il pulsante di acquisizione UUI per aprire la [finestra Live View](../how_to/Inspection_workflow.md#acquisizione-di-una-uui) del PCBA corrente.

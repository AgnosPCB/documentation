...
Um ein **REFERENZ**-Bild zu erstellen, folgen Sie den Schritten in der [folgenden Anleitung](../how_to/Inspection_workflow.md#generieren-einer-referenz) oder [laden Sie eine vorhandene REFERENZ](../how_to/Screen-layout.md#referenz-als-datei-laden).

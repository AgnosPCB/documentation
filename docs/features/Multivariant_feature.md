...
!!! warning "Caution"
    A reference variant must be manually created for each location on the PCB where the variation appears. The system does not automatically apply the variant to identical components in other positions.

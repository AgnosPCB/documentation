...
[Erstellen Sie ein Referenzbild](../how_to/Inspection_workflow.md#generieren-einer-referenz) oder wählen Sie eines [aus dem Repository](../how_to/Screen-layout.md#referenz-als-datei-laden) aus. Platzieren Sie anschließend das UUI und starten Sie die Inspektion.

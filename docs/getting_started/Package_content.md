...
| ESD MAT + ESD Wrist Strap + Ground Lead | ![Mat](../assets/mat.png) {width=300px}|
| Maintenance kit | ![Maintenance kit](../assets/v7/maintance-kit.png) {width=300px} |
...
|  **\*ONLINE UNITS ONLY\*** Pre-programmed Mini-computer + Keyboard and mouse | ![Mini-computer](../assets/v7/mini-computer.png) {width=300px} |
|  **\*OFFLINE UNITS ONLY\*** Pre-programmed desktop computer + Keyboard and mouse | ![desktop computer](../assets/Hummer_pc.png) {width=300px} |

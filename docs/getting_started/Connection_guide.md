...
=== "ONLINE version"
    ...
    2. Attach the mini computer to the support placed in the rear panel of the inspection platform. Align the holes on the bottom of the computer with the two screws of the support, as shown in the images.

        ![Minicomputer support](../assets/v7/4050N-pc-support.png){width=400px .center}


        ![Minicomputer bottom side](../assets/v7/mini-computer-bottom.png){width=300px .center}


        ![Minicomputer attached](../assets/v7/mini-computer-attached.png){width=300px .center}


    
    3. Connect the **19V power supply** to the rear connector of the mini computer.
    4. Connect the USB A to USB B angled cable between the rear panel of the platform and the mini computer.
    5. Connect the **AC power cord** to the rear panel of the platform.
    ...
    8. Attach the monitor to the front aluminium profile of the platform using the screw and nut provided on the back of the monitor.  **Make sure that the plastic part fits into the aluminium slot.**
        ...
        ![Front platform](../assets/v7/4050N-frame-monitor.png){width=400px .center}

        ![Monitor attached](../assets/v7/connect-monitor-attach.png){width=400px .center}

    9. Connect the HDMI cable to a HDMI port and the keyboard and mouse to the USB front ports of the mini computer.

=== "OFFLINE version"
    1. Place the green mat under the inspection platform. Ensure it is placed correctly and the table is not visible in the inspection area.
    2. Unpack the computer, open the left panel and **remove the protective foam** as shown in the video.
    ...
    4. Connect the **AC power cord** to the rear panel of the platform.

...
La imagen de **REFERENCIA** es la imagen de una PCBA libre de defectos utilizada para las inspecciones. Antes de generar la imagen de REFERENCIA, el operador debe inspeccionar la PCBA de REFERENCIA (placa DORADA) para asegurarse de que no tiene errores de fabricación.

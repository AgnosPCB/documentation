...
[Wählen Sie ein Referenzbild aus](../how_to/Screen-layout.md#load-reference-as-file), auf dem Sie eine Messung durchführen möchten, oder [erfassen Sie eine UUI](../how_to/Inspection_workflow.md#capturing-an-uui).

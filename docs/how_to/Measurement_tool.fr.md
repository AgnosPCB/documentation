...
[Sélectionnez une image de référence](../how_to/Screen-layout.md#load-reference-as-file) sur laquelle vous souhaitez effectuer une mesure, ou bien [capturez une UUI](../how_to/Inspection_workflow.md#capturing-an-uui).

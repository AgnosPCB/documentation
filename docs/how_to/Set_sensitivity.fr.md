...
![PCB avec erreurs en sensibilité normale](../assets/normal-sensitivity.png){.center}
...
![PCB avec erreurs en haute sensibilité](../assets/high-sensitivity.png){.center}
...
![PCB avec erreurs en très haute sensibilité](../assets/very-high-sensitivity.png){.center}

...
La sensibilidad se refiere al grado de meticulosidad o rigurosidad empleado por el sistema de inspección al escanear en busca de errores. Esencialmente, rige la capacidad del sistema para identificar incluso las discrepancias o anomalías más pequeñas dentro de los materiales inspeccionados.
...
![PCB con errores en sensibilidad muy alta](../assets/very-high-sensitivity.png){.center}

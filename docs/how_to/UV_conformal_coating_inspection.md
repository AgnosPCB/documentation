In this guide we will learn how to use the conformal coating inspection using the **AI-4050 AOI**.

!!! note "Note"
    This function requires installing a separate hardware kit. To learn how to install the UV kit follow the instructions in the following section:
...
![Live view window](../assets/UUI photo.PNG){.center}
...
The system displays the PCB under UV illumination, allowing operators to visually verify conformal coating presence and detect missing or insufficient coverage during inspection.

...
![Control board loaction](../assets/v7/UV_install/board_location.png){.center}


Loosen the screws on the terminal indicated in the image.

![Terminals loaction](../assets/v7/UV_install/terminals_location.png){.center}
...
![Terminals polarity](../assets/v7/UV_install/terminals_polarity.png){.center}
...
![Screws location](../assets/v7/UV_install/dc_screws.png){.center}
...
![DC converter installed](../assets/v7/UV_install/dc_installed.png){.center}
...
![Yellow marks](../assets/v7/UV_install/yellow_marks.png){.center}
...
![Inserting the UV leds](../assets/v7/UV_install/insert_uv.png){.center}
...
![Cable guides](../assets/v7/UV_install/cable_holder.png){.center}
...
![Cable routed](../assets/v7/UV_install/cable_routed.png){.center}
